      ...
      <div className="container mx-auto px-4 py-6 max-w-lg">
        ...
        >
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-red-100 font-black mt-1">Acompanha o teu progresso em tempo real</p>
          </div>
        </motion.div>

        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
          {/* Current Status Card Premium */}
          <Card className="relative overflow-hidden border-0 bg-slate-900 p-6 shadow-2xl">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-2 mb-6">
                  <div className="w-8 h-8 rounded-lg bg-blue-500 flex items-center justify-center">
                    <LineChartIcon className="w-5 h-5 text-slate-950" />
                  </div>
          ...
          <Card className="relative overflow-hidden border-0 bg-slate-900 p-6 shadow-2xl">
            <div className="relative z-10 space-y-6">
              <div className="space-y-3">
                <Label htmlFor="currentWeight" className="text-sm font-black text-white uppercase tracking-widest">Peso Atual (kg)</Label>
                <Input
                  id="currentWeight"
                  type="number"
                  value={currentWeight || ""}
                  onChange={(e) => setCurrentWeight(parseFloat(e.target.value) || null)}
                  className="text-xl font-black bg-slate-800 border-2 border-white/20 text-white placeholder:text-white/40 h-12 rounded-xl focus:border-emerald-500"
                  placeholder="Ex: 85"
                  min="30"
                  max="250"
                  step="0.1"
              ...
              <div className="space-y-3">
                <Label htmlFor="targetWeight" className="text-sm font-black text-white uppercase tracking-widest">Meta de Peso (kg)</Label>
                <Input
                  id="targetWeight"
                  type="number"
                  value={targetWeight || ""}
                  ...
                  step="0.1"
                />
                <div className="bg-emerald-500 p-2 rounded-lg inline-block shadow-lg">
